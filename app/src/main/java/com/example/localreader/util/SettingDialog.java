...
public class SettingDialog extends Dialog {
    ...
    @BindView(R.id.tv_size_default) TextView tv_size_default;
    @BindView(R.id.tv_bysong) TextView tv_bysong;
    @BindView(R.id.tv_fzkatong) TextView tv_fzkatong;
    @BindView(R.id.tv_hkshaonv) TextView tv_Hkshaonv;
    @BindView(R.id.tv_hwzhongsong) TextView tv_Hwzhongsong;
    @BindView(R.id.tv_kaiti) TextView tv_Kaiti;
    @BindView(R.id.tv_youyuan) TextView tv_Youyuan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_Hkshaonv.setTypeface(config.getTypeface(config.FONTTYPE_HKSHAONV));
        tv_Hwzhongsong.setTypeface(config.getTypeface(config.FONTTYPE_HWZHONGSONG));
        tv_Kaiti.setTypeface(config.getTypeface(config.FONTTYPE_KAITI));
        tv_Youyuan.setTypeface(config.getTypeface(config.FONTTYPE_YOUYUAN));
...
//        }
    ...
    private void selectTypeface(String typeface) {
        if (typeface.equals(Config.FONTTYPE_DEFAULT)) {
            ...
            setTextViewSelect(tv_Hkshaonv, false);
            setTextViewSelect(tv_Hwzhongsong, false);
            setTextViewSelect(tv_Kaiti, false);
            setTextViewSelect(tv_Youyuan, false);
            ...
            setTextViewSelect(tv_Kaiti, false);
            setTextViewSelect(tv_Youyuan, false);
        }else if (typeface.equals(Config.FONTTYPE_HKSHAONV)) {
            setTextViewSelect(tv_default, false);
            setTextViewSelect(tv_qihei, false);
            setTextViewSelect(tv_fzkatong, false);
            setTextViewSelect(tv_bysong, false);

            setTextViewSelect(tv_Hkshaonv, true);
            setTextViewSelect(tv_Hwzhongsong, false);
            setTextViewSelect(tv_Kaiti, false);
            setTextViewSelect(tv_Youyuan, false);
        }else if (typeface.equals(Config.FONTTYPE_HWZHONGSONG)) {
            setTextViewSelect(tv_default, false);
            setTextViewSelect(tv_qihei, false);
            setTextViewSelect(tv_fzkatong, false);
            setTextViewSelect(tv_bysong, false);
            ...
            setTextViewSelect(tv_Hkshaonv, false);
            setTextViewSelect(tv_Hwzhongsong, true);
            setTextViewSelect(tv_Kaiti, false);
            setTextViewSelect(tv_Youyuan, false);
        }else if (typeface.equals(Config.FONTTYPE_KAITI)) {
            setTextViewSelect(tv_default, false);
            setTextViewSelect(tv_qihei, false);
            setTextViewSelect(tv_fzkatong, false);
            setTextViewSelect(tv_bysong, false);
            ...
            setTextViewSelect(tv_Hkshaonv, false);
            setTextViewSelect(tv_Hwzhongsong, false);
            setTextViewSelect(tv_Kaiti, true);
            setTextViewSelect(tv_Youyuan, false);
        }else if (typeface.equals(Config.FONTTYPE_YOUYUAN)) {
            setTextViewSelect(tv_default, false);
            setTextViewSelect(tv_qihei, false);
            setTextViewSelect(tv_fzkatong, false);
            setTextViewSelect(tv_bysong, false);
            ...
            setTextViewSelect(tv_Hwzhongsong, false);
            setTextViewSelect(tv_Kaiti, false);
            setTextViewSelect(tv_Youyuan, true);
        }
    }
...
//            textView.setTextColor(getContext().getResources().getColor(R.color.black_color));
    ...
    @OnClick({R.id.tv_xitong, R.id.tv_subtract, R.id.tv_add, R.id.tv_size_default, R.id.tv_qihei, R.id.tv_fzkatong, R.id.tv_bysong,
            R.id.tv_default, R.id.iv_bg_default,R.id.tv_hkshaonv,R.id.tv_hwzhongsong,R.id.tv_kaiti,R.id.tv_youyuan,
            R.id.iv_bg_1, R.id.iv_bg_2, R.id.iv_bg_3, R.id.iv_bg_4})
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_bysong:
                ...
                break;
            case R.id.tv_hkshaonv:
                selectTypeface(Config.FONTTYPE_HKSHAONV);
                setTypeface(Config.FONTTYPE_HKSHAONV);
                break;
            case R.id.tv_hwzhongsong:
                selectTypeface(Config.FONTTYPE_HWZHONGSONG);
                setTypeface(Config.FONTTYPE_HWZHONGSONG);
                break;
            case R.id.tv_kaiti:
                selectTypeface(Config.FONTTYPE_KAITI);
                setTypeface(Config.FONTTYPE_KAITI);
                break;
            case R.id.tv_youyuan:
                selectTypeface(Config.FONTTYPE_YOUYUAN);
                setTypeface(Config.FONTTYPE_YOUYUAN);
                break;
